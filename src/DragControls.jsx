// Copied component from react-three-drei to fix a bug with the drag controls
...
export const DragControls = React.forwardRef(
  (
    {
      autoTransform = true,
      matrix,
    ...
    const bind = useGesture(
      {
        ...
        onDragStart: ({ event }) => {
          if (defaultControls !== null) defaultControls.enabled = false;
        ...
        onDrag: ({ xy: [dragX, dragY], intentional }) => {
          ...
          if (autoTransform) {
            ...
            const deltaWorldMatrix = ref.current.matrixWorld
              .clone()
        ...
        onDragEnd: () => {
          if (defaultControls !== null) defaultControls.enabled = true;
